...
namespace CacheMeIfYouCan.Configuration
{
    public interface IUpdateableCachedObjectConfigurationManager<T, TUpdates>
    {
        ...
        IUpdateableCachedObjectConfigurationManager<T, TUpdates> OnInitialized(Action<ICachedObject<T>> action);
        IUpdateableCachedObjectConfigurationManager<T, TUpdates> OnDisposed(Action<ICachedObject<T>> action);
