...
namespace CacheMeIfYouCan
{
    public sealed class LocalCacheEventsWrapperConfig<TKey, TValue>
    {
        ...
        public Action<IReadOnlyCollection<TKey>, ReadOnlyMemory<KeyValuePair<TKey, TValue>>, TimeSpan> OnGetManyCompletedSuccessfully { get; set; }
    ...
    {
        public Action<TOuterKey, IReadOnlyCollection<TInnerKey>, ReadOnlyMemory<KeyValuePair<TInnerKey, TValue>>, TimeSpan> OnGetManyCompletedSuccessfully { get; set; }
