...
namespace CacheMeIfYouCan
{
    public static class DistributedCacheFactoryExtensions
    {
        ...
        /// <returns></returns>
        public static IDistributedCacheFactory OnRemoveResult(
            this IDistributedCacheFactory cacheFactory,
        ...
        /// <param name="behaviour">How to add the <paramref name="onRemoveResult"/> action to the existing list of actions</param>
        /// <returns></returns>
        public static IDistributedCacheFactory<TK, TV> OnRemoveResult<TK, TV>(
            this IDistributedCacheFactory<TK, TV> cacheFactory,
        ...
        /// <param name="behaviour">How to add the wrapper which catches the duplicate requests to the existing list of wrapperFactories</param>
        /// <returns></returns>
        public static IDistributedCacheFactory<TK, TV> CatchDuplicateRequests<TK, TV>(
            this IDistributedCacheFactory<TK, TV> cacheFactory,
            bool catchDuplicateRequests = true,
            AdditionBehaviour behaviour = AdditionBehaviour.Append)
        {
