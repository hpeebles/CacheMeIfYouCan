...
namespace CacheMeIfYouCan.Internal
{
    internal interface ICacheInternal<TK, TV>
    {
        ...
        ValueTask<IList<GetFromCacheResult<TK, TV>>> Get(IReadOnlyCollection<Key<TK>> keys);
        ValueTask Set(IReadOnlyCollection<KeyValuePair<Key<TK>, TV>> values, TimeSpan timeToLive);
